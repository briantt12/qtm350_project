...
Oour report analyzes the evolution of primary, secondary, and tertiary school enrollment trends from 1971 to 2020 (as per the range in the data set) in Afghanistan, India, and Japan, representing different stages of economic development.
...
- **Impact of edcuation on economy.** Explore whether education level itself has an impact on economic development
